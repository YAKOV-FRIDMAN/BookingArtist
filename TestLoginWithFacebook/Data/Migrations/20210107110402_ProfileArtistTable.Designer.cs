...
namespace BookingArtistMvcCore.Data.Migrations
{
    ...
    [Migration("20210107110402_ProfileArtistTable")]
    partial class ProfileArtistTable
    {
            ...
            modelBuilder.Entity("TestLoginWithFacebook.Data.ModelsData.Artist", b =>
                {
                    ...
                    b.Property<int?>("ProfileArtistId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestLoginWithFacebook.Data.ModelsData.Artist", b =>
                {
                    ...
                    b.HasOne("TestLoginWithFacebook.Data.ModelsData.ProfileArtist", "ProfileArtist")
                        .WithMany()
                        .HasForeignKey("ProfileArtistId");
                });
