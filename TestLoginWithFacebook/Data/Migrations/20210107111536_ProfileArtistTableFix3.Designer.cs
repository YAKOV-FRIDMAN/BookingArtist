...
namespace BookingArtistMvcCore.Data.Migrations
{
    ...
    [Migration("20210107111536_ProfileArtistTableFix3")]
    partial class ProfileArtistTableFix3
    {
            ...
            modelBuilder.Entity("TestLoginWithFacebook.Data.ModelsData.ProfileArtist", b =>
                {
                    ...
                    b.HasIndex("FkIdArtist")
                        .IsUnique()
                        .HasFilter("[FkIdArtist] IS NOT NULL");
            ...
            modelBuilder.Entity("TestLoginWithFacebook.Data.ModelsData.ProfileArtist", b =>
                {
                    b.HasOne("TestLoginWithFacebook.Data.ModelsData.Artist", "Artist")
                        ...
                        .HasForeignKey("TestLoginWithFacebook.Data.ModelsData.ProfileArtist", "FkIdArtist");
                });
